// Package unix implements a unix domain socket writer which implements the gxlog.Writer.
//
...
// Write implements the interface gxlog.Writer. It writes logs to unix domain sockets.
